...
class puppet_metrics_dashboard (
  ...
  Optional[String[1]] $influx_archive_source = undef,
  Optional[String[1]] $grafana_archive_source = undef,
  Optional[Enum['docker', 'archive', 'package', 'repo']] $grafana_install_method = undef,
